        ...
        < div className="">
            <div className="navbar px-8 fixed z-10 backdrop-brightness-50">
                <div className="navbar-start">
                    ...
                    <h2 className='text-2xl text-white font-bold hidden lg:block'>Recipe Calories</h2>
                </div>
                ...
                <div className="navbar-end">
                    ...
                    <div className="flex  justify-center  items-center ">
                        ...
                        <input className="input  input-bordered rounded-full " placeholder="Search here" />
